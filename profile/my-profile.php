                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-grid">
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                    class="form-control readonly"
                                                    value="<?= htmlspecialchars($profile['role_name'] ?? 'Tiada Role'); ?>"
                                                    readonly>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                    class="form-control readonly"
                                                    value="<?= htmlspecialchars($profile['division_name'] ?? 'Tiada Division'); ?>"
                                                    readonly>
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                    class="form-control readonly"
                                                    value="<?= htmlspecialchars($profile['unit_name'] ?? 'Tiada Unit'); ?>"
                                                    readonly>
                                        </div>
                                    ...
                                    <div class="form-grid">
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                class="form-control readonly"
                                                value="<?= $profile['last_login'] ? date('d M Y H:i', strtotime($profile['last_login'])) : 'Never'; ?>"
                                                readonly>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                class="form-control readonly"
                                                value="<?= $profile['created_at'] ? date('d M Y H:i', strtotime($profile['created_at'])) : '-' ?>"
                                                readonly>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text"
                                                class="form-control readonly"
                                                value="<?= $profile['updated_at'] ? date('d M Y H:i', strtotime($profile['updated_at'])) : '-' ?>"
                                                readonly>
                                        </div>
